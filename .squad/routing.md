...
|-----------|----------|----------|
| Architecture & MCP compliance | Ripley | Design decisions, code review, MCP protocol compliance, system prompts |
| C#/.NET implementation | Dallas | Windows automation, MCP tools, serialization, native interop, performance |
| Testing & quality | Lambert | Unit tests, integration tests, LLM tests, edge cases, coverage |
