...
/// <summary>
/// Integration tests for the save action against WinUI 3 modern app harness.
...
public sealed class WinUISaveTests : IDisposable
{
    ...
    public WinUISaveTests(ModernTestHarnessFixture fixture)
    {
        _fixture = fixture;
        ...
        _testOutputDir = Path.Combine(Path.GetTempPath(), "mcp-windows-tests-winui");
